...
namespace Microshaoft
{
    ...
    public class DataGrid : ContentView
    {
        ...
        private double frozenRowHeightPlusSpacing
        {
            get
            {
                return HeaderHeight + RowSpacing;
            }
        }
        private double rowHeightPlusSpacing
        {
            get
            {
                ...
                for (int col = numberOfColumns - 1; col >= start + count; col--)
                {
                    ...
                    foreach (View v in cellInventoryByColumn[col])
                    {
                        ...
                        if (boundViewToCoords.TryGetValue(v, out t))
                        {
                            ...
                            boundViewToCoords[v] = new CoordPair(col, t.RowY);
                        }
                    }
                }
            }
        ...
        {
            if (SelectionModeEnum.Row == SelectionMode)
            {
        ...
        public void GetContentOffset(out double x, out double y)
        {
            x = ContentOffset_X;
            y = ContentOffset_Y;
        }
	...
	public static readonly BindableProperty BoundNameProperty =
        ...
        public bool SingleTap(double x, double y)
        {
